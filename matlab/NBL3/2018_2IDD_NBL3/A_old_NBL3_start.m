...
for i = 1:length(WORK.L_ele_IIO)
    ...
    WORK.(ele_L_lines{i}).arr_mol = WORK.(ele_L_lines{i}).arr_corr/ ele_MW(i) * 1E-6;         %data in mol/cm2 corrected for attenuation
end
...
for i = 1:length(WORK.K_ele_IIO)
    ...
    WORK.(ele_K_lines{i}).arr_mol = WORK.(ele_K_lines{i}).arr_corr/ ele_MW(i) * 1E-6;         %data in mol/cm2 corrected for attenuation
end
