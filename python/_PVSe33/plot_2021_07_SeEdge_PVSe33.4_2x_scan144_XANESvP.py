...
# scan 144 indices
plt.scatter([9,10,12,14,15], [35,35,35,35,35], color='red', s=3)
...
FNAME = r'\PVSe33.4_2x_scan0144_{s}_XANESpositions.eps'.format(s=channels[idx])
