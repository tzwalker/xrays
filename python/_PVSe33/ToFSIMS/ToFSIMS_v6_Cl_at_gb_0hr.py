...
the depth step for 0hr cell was 0.110um
this implies 9 indices are about 0.990um of the layer, comparable to the depth
    probed in the 500hr chlroine-at-grain-boundary analysis v6
...
#TOF_slice = TOF[1+36:10+36,:,:].sum(axis=0)
# comparable distance from TCO
TOF_slice = TOF[39-18-9:39-18,:,:].sum(axis=0)
...
# for full image
img2[95:135,125:165] = np.nan      # top-left
img2[80:120,420:460] = np.nan    # top-right
img2[380:420,145:185] = np.nan    # bottom-left
img2[365:405,430:470] = np.nan  # bottom-right
...
if save_mask == 1:
    FNAME = r'C:\Users\Trumann\Dropbox (ASU)\1_PVSe33 ex-situ\DATA\ToF_SIMS\0hr_TCO_mask_10043px.txt'
