...
Trumann
Sat Jul  2 16:57:41 2022

run main-PVSe33-ASCII-xsect.py with '500hr_inf' key before this program

this program plots the points for the Se XANES of the 500hr cell
...
FILENAME = r'\combined_ASCII_2idd_0151.h5.csv' # 500hr infinite cross section
...
FILE = r'C:\Users\Trumann\Dropbox (ASU)\1_PVSe33 ex-situ\DATA\XRF_XANES - cross section\500hr_inf_SeXANES_indices.csv'
points = pd.read_csv(FILE,skiprows=1)
x = list(points['x pixel no']-13) # subtract 13 to match cropped 500hr map
...
FNAME = r'\500hr_SeXANESpoints.pdf'
