...
FILENAME = r'\combined_ASCII_2idd_1086.h5.csv' # 0hr infinite cross section
...
FILE = r'C:\Users\Trumann\Dropbox (ASU)\1_PVSe33 ex-situ\DATA\XRF_XANES - cross section\0hr_inf_CuXANES_indices.csv'
points = pd.read_csv(FILE,skiprows=1)
x = list(points['x pixel no'])
y1 = list(points['y pixel no 1099'])
y2 = list(points['y pixel no 1100'])
...
FNAME = r'\0hr_scan1086_Cu_map_with_points.pdf'
