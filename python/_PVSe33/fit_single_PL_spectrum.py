...
baseline = baseline_als(intensity, 1E6, 0.001)
baseline_subtracted = intensity - baseline
plt.plot(baseline_subtracted)
# try to repeat
baseline1 = baseline_als(baseline_subtracted, 1E6, 0.01)
plt.plot(baseline1)
baseline_subtracted1 = baseline_subtracted - baseline1
plt.plot(baseline_subtracted1)
...
baseline_rubber = rubberband(energy, intensity)
intensity_rubber = baseline_subtracted - baseline_rubber
