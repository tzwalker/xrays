...
FNAME = r'\PVSe33.4_3 PL glass side map2.wdf'
...
plt.plot(energy, gauss1, 'r--', label='total_fit')
...
#%%
'''
TO PROCESS MAPS PIX-BY-PIX, spectra with single peak
...
if SAVE == 1:
    ...
    OUT_FILE = r'\gaussian fit params - 20210312 PVSe33.4_3 glass side PL map2.wdf.csv'
