...
The user is meant to interact with "home.py" and "pretty_plotting.py". The folder contents should be downloaded/copied to a local path---not a server or Dropbox folder---to avoid read/write permission complications. A small example set of H5 data is included in the folder "example_data".
