...
def plot_save_combined_channels(samples, master_list):
    for sample, set_of_lines in zip(samples, master_list):
        ...
        ax1.set_xlabel('Depth (um)', fontsize = 18)
        ax1.tick_params(axis='x', labelsize = 14)
        
        color = 'tab:red'
        lns1 = ax1.plot(x_calib, set_of_lines[0], color=color, label = 'XBIC')      #XBIC line
        ax1.set_ylabel('XBIC (nA)', color=color, fontsize = 18)
...
#         
#         color = 'tab:orange'
#         lns4 = ax2.plot(x_calib, set_of_lines[3], color=color, linestyle = '--', label = 'Cu')        #Cu line
#             
...
# =============================================================================
        ...
        plt.title(sample['Name'], fontsize = 18)
