...
Trumann
Thu Jun  2 16:52:46 2022

this cell is meant for Mariana's 2022 PCSV presentation

it is the same as 'plot_master.py' but rotates and converts XBIC to nA
...
cbar_scale_control = 1; MIN = 0; MAX = 50
normalize = 0
standardized = 0
sci_notation = 0

unit = u'(nA)'; colormap = 'magma'
