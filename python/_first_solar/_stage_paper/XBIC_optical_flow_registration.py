...
# --- Load the sequence
image0 = np.loadtxt(r"C:\Users\Trumann\Dropbox (ASU)\2_FS_operando\for_imageJ\XBIC\from_python\scan323_XBIC.txt")
image0 = image0 / image0.max()
image1 = np.loadtxt(r"C:\Users\Trumann\Dropbox (ASU)\2_FS_operando\for_imageJ\XBIC\from_python\scan339_XBIC.txt")
