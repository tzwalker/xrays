...
this program is for normalizing the XBIV channel to the us_ic
at 20C and 80C
...
PATH_IN = r'C:\Users\triton\Dropbox (ASU)\2_FS_operando\XBIV aligned image csvs\stage paper'
scans = [321,337]
...
norm_20 = XBIV[0] / US_IC[0]
norm_80 = XBIV[1] / US_IC[1]
...
pltTe = ax.imshow(img, cmap='afmhot', vmin=1.5,vmax=2.0)
ax.axis('off')
