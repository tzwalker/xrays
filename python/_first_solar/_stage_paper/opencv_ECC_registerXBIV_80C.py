...
im2_path = r"C:\Users\Trumann\Dropbox (ASU)\0_stage design\DATA\combined_ASCII_2idd_0337.h5.csv" # 20C - XBIV
...
plt.figure();plt.imshow(im1_F32_crop[10:170,10:275]);plt.figure();plt.imshow(im2_aligned[10:170,10:275])
